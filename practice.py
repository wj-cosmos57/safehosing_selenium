...
# 부동산 > 발급 click
wait.until(EC.element_to_be_clickable((By.XPATH, '//*[@id="cenS"]/div/ul/li[1]/div/ul/li[1]/a')))
...
# ## 다중 페이지 작업중 코드...
# while current_page <= min(10, total_pages):
# # document.getElementById('resultFrame').contentDocument.getElementById('frmOuterModal').contentWindow.f_goPage('1')
#     driver.execute_script("f_goPage('{current_page}')")
